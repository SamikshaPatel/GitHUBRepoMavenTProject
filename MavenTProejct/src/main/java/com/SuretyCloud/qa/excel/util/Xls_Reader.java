// Xls_reader is copied from the below link
...
package com.SuretyCloud.qa.excel.util;
/**
...
public class Xls_Reader {
	...
	// returns the row count in a sheet
	      ...
	      public String getExcelSheetNames(String sheetName) {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			sheet = workbook.getSheetAt(index);
			row = sheet.getRow(1); // getRow(1) as I have column headers in row 1 in my excel sheet
